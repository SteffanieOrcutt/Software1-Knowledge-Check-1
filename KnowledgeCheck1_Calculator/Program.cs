        ...
        static void Main(string[] args)
        {
            ...
            switch (input)
            {
                ...
                case "3":
                    ...
                    if (int.TryParse(multiplyNumber1, out int multNumb1) && int.TryParse(multiplyNumber2, out int multNumb2))
                    {
                        Console.Write($"{multNumb1} - {multNumb2} = ");
                        Console.Write(calculator.Multiply(multNumb1, multNumb2));
                    }
                    else
                    {
                        Console.WriteLine("One or more of the numbers is not an int");
